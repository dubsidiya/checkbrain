...
def findClusterNo( x, y ):
  return -1 if (x < 1 and y > 5) or (x > 7 and y < -5) or (x > 7 and y > 5) else \
         0 if (x < 2 and y > -3) or (x < 6 and y > 2) else \
         1 if (x < 5 and y > -2.5) or (x < 6.4 and y > -1)  else \
         2
