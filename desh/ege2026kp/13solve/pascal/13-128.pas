...
var k:=0;
    foreach var y in s do
      ...
      if ((y and 75)=75) and (z and 91=64) and not(addr(255,255,y,z).Contains('0.1'))
      then  k:=max(addr(255,255,y,z).Cnt('0'), k);
      print(2**k);
...
foreach var z in q do
 begin    
  ...
  if (n.Cnt>0) and (n[0]='108.133.75.64') then m:=max(m, x.GenAddr.cnt);  
  end;  
  print(m+2)            